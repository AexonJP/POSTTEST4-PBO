...
class animes {
    ...
    public animes (String nama, String hari, int episode, Float rating, String studio, String genre, String sipnosis){
        this.nama=nama;
        this.hari = hari;
    ...
    public animes (String nama, String hari, int episode, Float rating, String studio, String genre){
        this.nama=nama;
        this.hari = hari;
        this episode = episode;
        this.rating = rating;
...
class anime_mangas extends animes {
    String manga;
...
class anime_light_novels extends animes {
    String light_novel;
